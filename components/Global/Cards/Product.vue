<template>
  <div class="product">
    <div class="s">
      ...
      <a class="btn" :href="'https://api.whatsapp.com/send?phone=2347080569116&text=I want to order product found at - https://neasfashion.demo.joshytheprogrammer.com/shop/'+item.slug" target="_blank">Order</a>
    </div>
  </div>
</template>
